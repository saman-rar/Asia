...
export interface Product {
  ...
  title: string;
  /**
   * قیمت محصول به تومان یا واحد دلخواه شما
   */
  price: number;
  isOff?: boolean | null;
  /**
  ...
  /**
   * محصول شاخص برای نمایش در صفحه اصلی
   */
  ...
  handsfreeType?: ('wireless' | 'collar-style' | 'wire') | null;
  headphoneConnection?: ('wireless' | 'wire' | 'both') | null;
